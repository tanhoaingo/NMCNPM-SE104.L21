...
namespace BookStore.DataSet1TableAdapters {
    ...
    public partial class ACCOUNTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [ACCOUNT] WHERE (([ID] = @Original_ID) AND ((@IsNull_USERNAME = 1 AND" +
                " [USERNAME] IS NULL) OR ([USERNAME] = @Original_USERNAME)) AND ((@IsNull_PASSWOR" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [ACCOUNT] ([USERNAME], [PASSWORD]) VALUES (@USERNAME, @PASSWORD);\r\nSE" +
                "LECT ID, USERNAME, PASSWORD FROM ACCOUNT WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [ACCOUNT] SET [USERNAME] = @USERNAME, [PASSWORD] = @PASSWORD WHERE (([ID] = @Original_ID) AND ((@IsNull_USERNAME = 1 AND [USERNAME] IS NULL) OR ([USERNAME] = @Original_USERNAME)) AND ((@IsNull_PASSWORD = 1 AND [PASSWORD] IS NULL) OR ([PASSWORD] = @Original_PASSWORD)));
